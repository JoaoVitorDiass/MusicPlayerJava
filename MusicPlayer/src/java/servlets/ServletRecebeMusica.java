...
public class ServletRecebeMusica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Part upfile = request.getPart("inputTag");
        String genero = request.getParameter("estilo");
        String nome = request.getParameter("nome");
        String artista  = request.getParameter("artista");
        
        String NomeArq = nome+"_"+genero+"_"+artista+".mp3";
        try{
            ...
            out = new FileOutputStream(new File(pasta.getAbsolutePath()+"/"+NomeArq));
